...
//     axios.get(`${baseUrl}auth/achievements`)
//       .then((res) => {
...
//     e.preventDefault();
//     axios.post(`${baseUrl}auth/achievements`, formData)
//       .then((res) => {
//         if (res.data.success) {
//           toast.success(res.data.message);
//           const selectedAlumnus = alumni.find(a => a.id === parseInt(formData.alumnus_id));
//           setAchievements([...achievements, { ...formData, id: res.data.id, name: selectedAlumnus ? selectedAlumnus.name : "Unknown" }]);
//           setFormData({ alumnus_id: "", title: "", description: "", date_achieved: "" });
//         }
//       })
//       .catch((err) => {
...
//       axios.delete(`${baseUrl}auth/achievements/${id}`)
//         .then((res) => {
//           if (res.data.success) {
//             toast.success(res.data.message);
...
//                   />
//                 </div>
//                 <button type="submit" className="btn btn-primary mt-2">Add Achievement</button>
//               </form>
//             )}
//           </div>
//         </div>
...
const Achievements = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    attachment: null, // attachment field
  });
  const [loading, setLoading] = useState(true); // Loading state to handle async fetch
