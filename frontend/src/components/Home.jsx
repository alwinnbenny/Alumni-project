                ...
                <div className="container h-100">
                    <div className="row h-100 align-items-center justify-content-center">
                        <div className="col-lg-8  text-center">
                            <h1 className="text-white font-weight-bold display-4 mb-4">MEETING THE MOMENT,</h1>
                            <h1 className="text-white font-weight-bold display-3 mb-4">TOGETHER</h1>

                            <p className="text-white-75 font-weight-bold lead mb-5">Connecting CEP Graduates Across The Globe!</p>
